...
BEGIN {
    ...
    require '/Users/kslipko/innovationcampuus/uChat/newClientServer/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/kslipko/innovationcampuus/uChat/newClientServer/openssl/test/fips-and-base.cnf';
    shift;
