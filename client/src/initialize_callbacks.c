...
void mx_init_callbacks_add_contact(t_uchat_application* app) {
    g_signal_connect(app->scenes->add_contact_dwindow->w_add_contact , "delete-event", G_CALLBACK (on_delete_event), app->scenes->add_contact_dwindow->w_add_contact);
...
void mx_init_create_group(t_uchat_application* app) {
    g_signal_connect(app->scenes->create_group_dwindow->w_create_group , "delete-event", G_CALLBACK (on_delete_event), app->scenes->create_group_dwindow->w_create_group);
